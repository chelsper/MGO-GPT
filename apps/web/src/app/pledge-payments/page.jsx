...
const queryErrors = {
  ...
  query_execution_failed: `Blackbaud could not complete this query job. Check query ${OPEN_PLEDGE_QUERY_ID} in NXT, then cancel and refresh.`,
  ...
  query_not_executable_gift_query: `Query ${OPEN_PLEDGE_QUERY_ID} must be an executable Gift query without prompts. Check the query and your Query API access.`,
