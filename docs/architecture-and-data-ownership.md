...
Large UI and integration files are candidates for incremental extraction behind
tests, not a prerequisite rewrite. Route authorization must remain server-side.
